  ...
  <a-modal
    ...
    <a-spin :spinning="formLoading">
      <a-form :form="form">
        ...
        <a-form-item label="客户类型" :labelCol="labelCol" :wrapperCol="wrapperCol" has-feedback>
          <a-radio-group
            placeholder="请选择机构类型！"
            v-decorator="['orgtype',{rules: [{ required: true, message: '请选择客户类型！' }]}]">
        ...
        <a-form-item label="客户名称" :labelCol="labelCol" :wrapperCol="wrapperCol" has-feedback>
          <a-input placeholder="请输入客户名称" v-decorator="['name', {rules: [{required: true, message: '请输入客户名称！'}]}]" />
        </a-form-item>
        ...
        <a-form-item label="上级客户" :labelCol="labelCol" :wrapperCol="wrapperCol" has-feedback>
          <a-tree-select
            v-decorator="['pid', {rules: [{ required: true, message: '请选择上级客户！' }]}]"
            style="width: 100%"
