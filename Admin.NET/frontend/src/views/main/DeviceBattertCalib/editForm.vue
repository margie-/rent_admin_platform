          ...
          this.form.setFieldsValue(
            {
              ...
              batterySeries: record.batterySeries,
              electronicPer_s: record.electronicPer_s,
              electronicVol_s: record.electronicVol_s,
              electronicVol_2: record.electronicVol_2,
              battertRemark: record.battertRemark,
              infoSourceType: record.infoSourceType,
      ...
      handleSubmit () {
        ...
        validateFields((errors, values) => {
          if (!errors) {
            ...
            DeviceBattertCalibEdit(values).then((res) => {
              if (res.success) {
